...
const itemTag = (item) => `
      <div class="icon">
        ...
        <div class="info">
          <span class="name">${item.lastName + ' ' + item.maidenName + ' ' + item.firstName}</span>
          <span class="birth">${item.birthDate.replace('-', '/')}</span>
          <span class="department">${item.company.department}</span>
